...
# assets/, languages/, templates/, uninstall.php and a production vendor/. Composer runs inside
...
# supplies it. The result is dist/woo-organization-accounts-pro-<version>.zip plus a .sha256,
...
STAGE="$(mktemp -d "${TMPDIR:-/tmp}/woap-build.XXXXXX")"
...
for dir in includes assets languages templates; do
