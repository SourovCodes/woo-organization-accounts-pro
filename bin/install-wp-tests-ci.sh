...
#   DB_NAME      Test database (default woo_org_tests).
...
PLUGIN_LINK="$WP_ROOT/wp-content/plugins/woo-organization-accounts-pro"
...
CREATE_DB="$(mktemp "${TMPDIR:-/tmp}/woap-create-db.XXXXXX")"
...
define( 'WP_TESTS_TITLE', 'Woo Organization Accounts Test Suite' );
